...
module.exports.send = (email, orderid, username, total) => {
  const mailOptions = {
    ...
    <p>To view your invoice from SneakerShop for $${total}, or to download a PDF copy for your record please <a href="http://localhost:3030/shop/download/${orderid}">CLick here</a></p>
    <br>
