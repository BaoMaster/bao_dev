...
const RenderArrow = ({ className, style, onClick, type }) => {
  return (
    <div className={className} style={{ ...style }} onClick={onClick}>
      {type === "pre" && (
        <CaretLeftOutlined style={{ fontSize: 24, color: "#08c" }} />
      )}
      {type === "next" && (
        <CaretRightOutlined style={{ fontSize: 24, color: "#08c" }} />
      )}
    </div>
  );
};
                  ...
                  >
                    ...
                    >
                      ...
                      <p>
                        ...
                        whatsoever, rather, it embraces such connections as
                        palettes are nearly shot-for-shot the same as its
                        high-end counterpart, though sans any of the luxury
                        imprint’s signature all-over graphic or their luxe
                        Italian made leathers.#airjordan1mid
                      </p>
                    </div>
                    <div>
                      <img
                  ...
                  <div onClick={(e) => this.handleSelect(2)}>
                    ...
                    >
                      ...
                      <p>
                        ...
                        Spider-Man: Into the Spider-Verse. Using the blueprint
                        of the original Chicago colorway that is worn by the
                        character Miles Morales in the film, the design features
                        a white and and red leather upper with a few
                        modifications inspired by Spider-Man. The red leather
                        panels on the upper feature a tonal dot print that is
                        also reflective, referencing Spider-Man¬ís suit. The
                        Nike Air tongue tag is presented in blue and red as
                        another nod to the superhero, while an icy clear outsole
                        completes the colorway. Released on December 14, 2018 to
                        coincide with the opening of the film, the Spider-Man x
                        Air Jordan 1 Origin Story is a must-have for sneaker and
                  ...
                  <div>
                    ...
                    >
                      ...
                      <p>
                        ...
                        The shoe comes with a leather upper, the iconic Jumpman
                        logo on the tongue and the classic Wings logo
                        embroidered on the heel. An encapsulated Air-Sole unit
                        and a rubber outsole with a pivot point tread pattern
                        finish the model.
                      </p>
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <p>
                        ...
                        Jordan 1 Retro High is a limited edition release
                        designed for the famous basketball player Russel
                        Westbrook and its highlight is the upper. Combined with
                        both leather (leather) and nubuck leather for a
                        luxurious look.
                      </p>
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <p>
                        ...
                        safety of the wearer. Exquisite design, trendy design is
                        youthful, is a design for you, shoes focus on shape with
                        each street, exuding a youthful, elegant look. The
                        sewing is meticulous and the glue line is firm and
