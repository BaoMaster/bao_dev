/* eslint-disable */
import { CaretLeftOutlined, CaretRightOutlined, LeftOutlined, MessageOutlined, RightOutlined } from '@ant-design/icons';
...
const RenderArrow = ({ className, style, onClick, type }) => {
  return (
    <div className={className} style={{ ...style }} onClick={onClick}>
      {type === 'pre' && <LeftOutlined style={{ fontSize: 24, color: 'black' }} />}
      {type === 'next' && <RightOutlined style={{ fontSize: 24, color: 'black', height: '50px' }} />}
    </div>
  );
};
...
class Slider extends React.Component {
  ...
  render() {
    ...
    return (
      <div className='container' style={{ width: '845px' }}>
        <div className='row'>
              ...
              <div>
                <SlickSlider {...settings}>
                  ...
                  <div>
                    ...
                    <div>
                      <img style={{ paddingLeft: '60px' }} src={shoes5} className='girl img-responsive' />
                    </div>
                  </div>
                </SlickSlider>
              </div>
