              ...
              <header id='header'>
                ...
                <Layout>
                  ...
                  >
                    ...
                    <div className='col-sm-3' style={{ marginLeft: '25%', marginTop: '50px', lineHeight: '0px' }}>
                      <div className='search_box pull-right' style={{ marginTop: '10px', border: '2px solid red', lineHeight: '0px', width: '512px', height: 'auto' }}>
                        <input
                          style={{
                            width: '450px',
                            backgroundColor: 'white',
                          ...
                          placeholder='Search'
                        />
                        <button style={{ width: '58px', height: '36px', backgroundColor: '#EE4D2D', color: 'white', border: '2px solid white' }}>
                          <SearchOutlined />
                        </button>
                      </div>
                    </div>
